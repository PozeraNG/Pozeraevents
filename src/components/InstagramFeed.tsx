...
const posts = [
  { src: "/images/insta-feed-1.png", alt: "Hands with wedding rings" },
  { src: "/images/insta-feed-2.png", alt: "Couple at an event" },
  { src: "/images/insta-feed-3.jpg", alt: "Couple embracing outdoors" },
  { src: "/images/insta-feed-4.png", alt: "Bride and groom portrait" },
];
